...
plot './exact/Riemann_0.2s.txt' u 1:4 with lines lw 4 lt rgb "black" title "Exact", \
     ...
     './output/Type_1_40.dat' u 4:8 with lines lw 2 lt rgb "red" title "Riemann"
...
plot './exact/Riemann_0.2s.txt' u 1:2 with lines lw 4 lt rgb "black" title "Exact", \
     ...
     './output/Type_1_40.dat' u 4:7 with lines lw 2 lt rgb "red" title "Riemann"
...
plot './exact/Riemann_0.2s.txt' u 1:3 with lines lw 4 lt rgb "black" title "Exact", \
     ...
     './output/Type_1_40.dat' u 4:5 with lines lw 2 lt rgb "red" title "Riemann"
...
plot './exact/Riemann_0.2s.txt' u 1:5 with lines lw 4 lt rgb "black" title "Exact", \
     ...
     './output/Type_1_40.dat' u 4:9 with lines lw 2 lt rgb "red" title "Riemann"
